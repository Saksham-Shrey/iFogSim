...
/**
 * Cloud Datacenter with 50% Data Forwarding
 * For every 100 sensor readings, only 50 are forwarded to actuator
 */
public class SimpleCloudDatacenter_HalfData {
	static List<FogDevice> fogDevices = new ArrayList<FogDevice>();
	static List<Sensor> sensors = new ArrayList<Sensor>();
	static List<Actuator> actuators = new ArrayList<Actuator>();
	
	public static void main(String[] args) {
		Log.printLine("Starting Cloud Datacenter with 50% Data Forwarding...");
		...
		try {
			...
			String appId = "cloud_app_half_data";
			...
			Log.printLine("Cloud Datacenter with 50% Data Forwarding finished!");
		} catch (Exception e) {
			e.printStackTrace();
	...
	/**
	 * Creates application with 50% selectivity
	 * For every 100 sensor readings, only 50 commands are sent to actuator
	 */
	...
	private static Application createApplication(String appId, int userId) {
		...
		// KEY CHANGE: Selectivity is 0.5 (50%)
		// For every 100 temperature readings, only 50 cooling commands are sent
